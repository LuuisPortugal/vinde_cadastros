    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form role="form" class="form-horizontal group-border-dashed">
                            <fieldset>
                                <legend>Dados Pessoais</legend>
                                <div class="form-group">
                                    <label class="control-label col-sm-1" for="cpfID">CPF</label>
                                    <div class="col-sm-2">
                                        <input type="text" name="cpf" class="form-control" id="cpfID" />
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text" name="celular" class="form-control" id="celularID" />
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <select name="estadoCivil" class="form-control" id="estadoCivilID">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <input type="hidden" name="endereco" class="form-control" id="enderecoID" />
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="control-label col-sm-2" for="rendaFamiliarID">Renda Familiar
                                        (média)</label>
                                    <div class="col-sm-3">
                                        <select name="rendaFamiliar" class="form-control" id="rendaFamiliarID">
                                            <option value>Selecione</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="necessidadeBasica" class="form-control"
                                               id="necessidadeBasicaID"></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <textarea name="descrisaoCristaoComPolitica" class="form-control"
                                                  id="descrisaoCristaoComPoliticaID"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="papelIgrejaSociedade" class="form-control"
                                                  id="papelIgrejaSociedadeID"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="propositoDeVidaNaTerra" class="form-control"
                                                  id="propositoDeVidaNaTerraID"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="propositoMinisterial" class="form-control"
                                                  id="propositoMinisterialID"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="motivacaoParaFazerOQueJaFaz" class="form-control"
                                                  id="motivacaoParaFazerOQueJaFazID"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="atividadesPreferidasParaTempoLivre" class="form-control"
                                                  id="atividadesPreferidasParaTempoLivreID"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="password" name="passwordConfirme" class="form-control" id="passwordConfirmeID" title="Digite a mesma senha" />
                                    </div>
                                </div>
                            </fieldset>
    ...
    <script type="text/javascript">
        $(document).ready(function (document_ready) {
            ...
            $("#escolaridadeID").on("change", function (filhosID_change) {
                $('#cursoEscolaridadeID').attr('disabled', ['1', '2'].indexOf($(this).val()) != -1);
            });
            ...
            $("#vontadeServirEmDepartamentoID").on("change", function (filhosID_change) {
                $('#descrisaoVontadeServirEmDepartamentoID').attr('disabled', $(this).is(":not(:checked)"));
            });

            $("#tocaInstrumentosID").on("change", function (filhosID_change) {
                $('#descrisaoTocaInstrumentosID').attr('disabled', $(this).is(":not(:checked)"));
            });
